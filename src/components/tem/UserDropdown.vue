...
// const userMenu = ref([
//   { id: 1, icon: UilUser, label: '個人資料', action: () => router.push('/my/account') },
//   { id: 2, icon: UilFileAlt, label: '瀏覽紀錄', action: () => router.push('/my/history') },
//   { id: 3, icon: UilHeart, label: '我的收藏', action: () => router.push('/my/collections') },
//   { id: 4, icon: UilLightbulbAlt, label: '小知識', action: () => router.push('/my/tips') },
//   { id: 5, icon: UilSignOutAlt, label: '登出', action: () => user.logout() },
// ])
